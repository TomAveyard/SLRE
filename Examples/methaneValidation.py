...
solverParameters = SolverParameters(bartzEquationCoefficient=0.026*0.3, coolantSideHeatTransferCorrelation="dittus-boelter", includeRoughnessCorrection=False)
